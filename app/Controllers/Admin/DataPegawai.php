...
class DataPegawai extends BaseController
{
    ...
    public function generateNIP()
    {
        ...
        $nipTerakhir = $pegawaiTerakhir ? $pegawaiTerakhir['nip'] : 'RSI-0000';
        $angkaNIP = (int) substr($nipTerakhir, 4);
        $angkaNIP++;
        return 'RSI-' . str_pad($angkaNIP, 4, '0', STR_PAD_LEFT);
    }
        ...
        $rules = [
            ...
            'foto' => [
                ...
                'errors' => [
                    ...
                    'mine_in' => "Jenis file yang diizinkan hanya PNG atau JPEG"
                ],
            ],
    ...
    function delete($id)
    {
        ...
        if ($pegawai) {
            ...
            $presensiModel->where('id_pegawai', $id)->delete();
