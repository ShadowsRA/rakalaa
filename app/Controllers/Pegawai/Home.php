...
class Home extends BaseController
{
    ...
    public function presensi_masuk()
    {
        ...
        if ($jarak_meter > $radius) {
            session()->setFlashdata('gagal', 'Presensi gagal, lokasi berada diluar radius kantor');
    ...
    public function presensi_masuk_aksi()
    {
        ...
        session()->setFlashData('berhasil', 'Presensi masuk berhasil tersimpan');
    ...
    public function presensi_keluar_aksi($id)
    {
        ...
        session()->setFlashData('berhasil', 'Presensi keluar berhasil tersimpan');
